...
# label ; K Bytes literal ; expected pc ; expected status ; balances map ; expected amountOut (- = unchecked)
#
...
CASES=(
  ...
  'floorNotCeil;b"";91;Running;bal(170,4660) |-> 5;0'
  'floorNonDividing;b"";91;Running;bal(170,4660) |-> 5;11'
...
fail=0
for c in "${CASES[@]}"; do
  IFS=';' read -r label lit want_pc want_st bals want_ao <<< "$c"
